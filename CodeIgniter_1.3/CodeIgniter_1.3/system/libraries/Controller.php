...
class Controller extends CI_Base {
	 ...
	 * @return	array
	 */
	function _ci_load_model($model, $name = '')
	{
		if ($name == '')
		{
			$name = $model;
		...
		if (isset($this->$name))
		{
			show_error('The model name you are loading is the name of a resource that is already being used.');
		}
		...
		if ( ! $this->_ci_is_loaded('db') OR ! class_exists('CI_DB_active_record'))
		{
