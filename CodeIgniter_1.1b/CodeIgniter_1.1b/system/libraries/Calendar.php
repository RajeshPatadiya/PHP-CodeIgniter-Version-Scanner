...
class _Calendar {
	...
	|==========================================================
	|
	| Loads the language file and sets the default time reference
	|
	*/
	function _Calendar()
	{
	...
	*/
	function get_month_name($month)
	{
		...
		if ($this->lang->line($month) === FALSE)
		{
			return ucfirst(str_replace('cal_', '', $month));
		}

		return $this->lang->line($month);
	}
	...
	*/
	function get_day_names()
	{
		...
		{			
			$days[] = ($this->lang->line('cal_'.$val) === FALSE) ? ucfirst($val) : $this->lang->line('cal_'.$val);
		}
	...
	*/
	...
	|==========================================================
	|
	| This is used in the event that the user has not 
	| created their own template
	|
	*/
