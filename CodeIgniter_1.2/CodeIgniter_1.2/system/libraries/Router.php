...
class _Router {
	...
	|=================================================
	|
	| Simply loads the application/config/routes.php file.
	|
	*/
	function _Router($uri_protocol = 'auto')
	{	
		$this->uri_protocol = $uri_protocol;
