...
class _Loader {
	...
	*/	
	function database($db = '', $return = FALSE)
	{
		...
		if ($return === TRUE)
		{
			return $obj->init_database($db, TRUE);
		}
		else
		{
			$obj->init_database($db);
		}
	}
	...
	*/
	...
	{	
		...
		|----------------------------------------------
		|
		| This allows the view files to act as controller children 
		|
		*/
		$obj =& get_instance();
