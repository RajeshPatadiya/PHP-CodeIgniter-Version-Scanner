...
class _DB {
	...
	|
	*/
	function _DB($hostname, $username = '', $password = '', $database = '', $create_db = FALSE)
	{
		if ( ! strpos($hostname,'://')) 
		{
	...
	*/
    function query($sql, $binds = FALSE)
    {
		...
		*/
		...
		/*
		|----------------------------------------
		| Instantiate and return the result object
		|----------------------------------------
		*/
		return new _DB_result($this->conn_id, $this->result_id);
	}
	...
	*/
	...
	{	
		...
		foreach ($binds as $val)
		{
			...
			// Just in case their replacement string has the bind character
...
class _DB_result {
	...
	function _DB_result($conn_id, $result_id)
	{
