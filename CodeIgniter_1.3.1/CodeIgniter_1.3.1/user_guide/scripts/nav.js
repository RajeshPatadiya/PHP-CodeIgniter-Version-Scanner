function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
			...
			'<li><a href="'+base+'general/creating_libraries.html">Creating Core Libraries</a></li>' +
			'<li><a href="'+base+'general/ancillary_classes.html">Creating Ancillary Classes</a></li>' +
